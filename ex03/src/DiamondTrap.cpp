...
/*   Updated: 2026/02/11 20:49:06 by takawauc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
DiamondTrap::DiamondTrap(void) : ClapTrap(kDefaultName + sufix), _name(kDefaultName)
{
  std::cout << "DiamondTrap default constructor called.\n";

  _hitPoint = FragTrap::kDefaultHitPoint;
  _energyPoint = ScavTrap::kDefaultEnergyPoint;
  _attackDamage = FragTrap::kDefaultAttackDamage;
}

DiamondTrap::DiamondTrap(std::string name) : ClapTrap(name + sufix), _name(name)
{
